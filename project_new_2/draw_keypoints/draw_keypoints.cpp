...
void draw_keypoints(Mat input_image , Mat second_intput_image, vector<Point2f > myPoints_one, vector<Point2f > myPoints_two) {
	...
	cv::drawKeypoints(input_image, myKeypoints_number, output1);
	cv::drawKeypoints(second_intput_image, myKeypoints_letter, output2);

	imshow("sorted1.jpg", output1);
	imshow("sorted2.jpg", output2);
...
vector<Mat> draw_keypoints1(Mat input_image, Mat second_intput_image, vector<Point2f > myPoints_one, vector<Point2f > myPoints_two) {
